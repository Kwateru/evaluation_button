...
* DB接続のときに使う接続情報（ユーザー名とパスワード）は無意味な文字列にする。
　※無意味な文字列にする必要はないが念のため。接続情報は別課題で適切な取り扱いを出来るようにする。
* 
...
など
## 3.画面設計
<img width="700" alt="image" src="https://github.com/ppf-academy/class-c-01-05/blob/main/image/SelfIntroduction5.png">
